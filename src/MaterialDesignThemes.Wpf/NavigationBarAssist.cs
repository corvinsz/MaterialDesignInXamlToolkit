...
/// <summary>
/// Provides attached properties for customizing the appearance and behavior of <see cref="NavigationBar"/> controls.
/// </summary>
public static class NavigationBarAssist
{
    ...
    /// <summary>
    /// Determines whether the selection background is visible.
    /// </summary>
    ...
    /// <summary>
    /// Defines the corner radius of the selection background.
    /// </summary>
    ...
    /// <summary>
    /// Defines the icon displayed when the navigation item is not selected.
    /// </summary>
    ...
    /// <summary>
    /// Defines the icon displayed when the navigation item is selected.
    /// </summary>
    ...
    /// <summary>
    /// Defines the size of the navigation item icon.
    /// </summary>
    ...
    /// <summary>
    /// Determines whether navigation item text is visible.
    /// </summary>
